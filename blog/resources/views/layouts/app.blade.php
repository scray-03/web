...
<body class="mobile_nav_class jl-has-sidebar">
                            ...
                            <div class="main_menu col-md-12">
                                <div class="logo_small_wrapper_table">
                                    <div class="logo_small_wrapper">
                                        ...
                                        <a class="logo_link" href="index.html">
                                            <img src="assets/img/logo.png" alt="Just another WordPress site" />
                                        </a>
                                        <!-- end logo -->
                                    </div>
                                </div>
                                ...
                                <div class="menu-primary-container navigation_wrapper">
                                    <ul id="mainmenu" class="jl_main_menu">
                                        <li class="menu-item menu-item-has-children"> <a href="#">Home<span
                                                    class="border-menu"></span></a>
                                            <ul class="sub-menu">
                                                <li class="menu-item"><a href="index.html">Home Demo 1<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-1.html">Home Demo 2<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-2.html">Home Demo 3<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-3.html">Home Demo 4<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-4.html">Home Demo 5<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-5.html">Home Demo 6<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-6.html">Home Demo 7<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-7.html">Home Demo 8<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-8.html">Home Demo 9<span
                                                            class="border-menu"></span></a>
                                                </li>
                                                <li class="menu-item"><a href="index-9.html">Home Demo 10<span
                                                            class="border-menu"></span></a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item menu-item-has-children"> <a href="#">Features<span
                                                    class="jl_menu_lb jl_lb_blue">New</span><span
                                                    class="border-menu"></span></a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children"> <a href="#">Post
                                                        Layout<span class="border-menu"></span></a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="post-layout-1.html">Post layout
                                                                1<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-2.html">Post layout
                                                                2<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-3.html">Post layout
                                                                3<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-4.html">Post layout
                                                                4<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-5.html">Post layout
                                                                5<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-6.html">Post layout
                                                                6<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-7.html">Post layout
                                                                7<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-layout-8.html">Post layout
                                                                8<span class="border-menu"></span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item menu-item-has-children"> <a href="#">Post
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="post-format-1.html">Post format
                                                                standard<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-format-2.html">Post format
                                                                gallery<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-format-3.html">Post Format
                                                                Qoute<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-format-4.html">Post format
                                                                video<span class="border-menu"></span></a>
                                                        </li>
                                                        <li class="menu-item"><a href="post-format-5.html">Post format
                                                                audio<span class="border-menu"></span></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li class="menu-item"><a href="gaming.html">Gaming<span
                                                    class="border-menu"></span></a>
                                        </li>
                                        <li class="menu-item"><a href="active.html">Active<span
                                                    class="border-menu"></span></a>
                                        </li>
                                        <li class="menupost menu-item"> <a href="business.html">Business<span
                                                    class="jl_menu_lb jl_lb_red">Hot</span><span
                                                    class="border-menu"></span></a>
                                            <ul class="sub-menu menu_post_feature">
                                                <li> <span class="jl_none_space"></span>
                                                    <div id="disto_recent_large_widgets-2"
                                                        class="widget main_post_style"> <span
                                                                ...
                                                                <div class="image_post feature-item featured-thumbnail">
                                                                    <a href="#" class="feature-link"
                                                                        ...
                                                                        <img width="400" height="280"
                                                                            src="assets/img/2019/02/irina-iriser-654436-unsplash-400x280.jpg"
                                                                ...
                                                                <div class="wrap_box_style_main image-post-title">
                                                                    <div class="title_content_wrapper">
                                                                        <h3 class="image-post-title"><a href="#">
                                                                                People are enjoy the job that they
                                                                                love</a>
                                                                        </h3>
                                                            ...
                                                            <div class="recent_post_large_widget">
                                                                <div class="image_post feature-item featured-thumbnail">
                                                                    <a href="#" class="feature-link"
                                                                        ...
                                                                        <img width="400" height="280"
                                                                            src="assets/img/2018/11/mikky-koopac-1056364-unsplash-400x280.jpg"
                                                                            class="attachment-disto_slider_grid_small size-disto_slider_grid_small wp-post-image"
                                                                            alt="" />
                                                                        <div class="background_over_image"></div>
                                                                    </a> <span class="meta-category-small"><a
                                                                ...
                                                                <div class="wrap_box_style_main image-post-title">
                                                                    <div class="title_content_wrapper">
                                                                        <h3 class="image-post-title"><a href="#">
                                                                                Nice photo shooting with hand classic
                                                                                style</a>
                                                                        </h3>
                                                                        <span class="jl_post_meta"><span
                                                                                class="jl_author_img_w"> <img
                                                            ...
                                                            <div class="recent_post_large_widget">
                                                                <div class="image_post feature-item featured-thumbnail">
                                                                    <a href="#" class="feature-link"
                                                                        ...
                                                                        <img width="400" height="280"
                                                                            src="assets/img/2019/02/bruce-christianson-559084-unsplash-400x280.jpg"
                                                                            class="attachment-disto_slider_grid_small size-disto_slider_grid_small wp-post-image"
                                                                            alt="" />
                                                                        <div class="background_over_image"></div>
                                                                    </a> <span class="meta-category-small"><a
                                                                ...
                                                                <div class="wrap_box_style_main image-post-title">
                                                                    <div class="title_content_wrapper">
                                                                        <h3 class="image-post-title"><a href="#">
                                                                                It’s always fun time and smile in the
                                                                                summer</a>
                                                                        </h3>
                                                                        <span class="jl_post_meta"><span
                                                                                class="jl_author_img_w"> <img
                                                            ...
                                                            <div class="recent_post_large_widget">
                                                                <div class="image_post feature-item featured-thumbnail">
                                                                    <a href="#" class="feature-link"
                                                                        ...
                                                                        <img width="400" height="280"
                                                                            src="assets/img/2018/11/icons8-team-554108-unsplash-400x280.jpg"
                                                                            class="attachment-disto_slider_grid_small size-disto_slider_grid_small wp-post-image"
                                                                            alt="" />
                                                                        <div class="background_over_image"></div>
                                                                    </a> <span class="meta-category-small"><a
                                                                ...
                                                                <div class="wrap_box_style_main image-post-title">
                                                                    <div class="title_content_wrapper">
                                                                        <h3 class="image-post-title"><a href="#">
                                                                                Best inspire dark photo in the winter
                                                                                season</a>
                                                                        </h3>
                                                                        <span class="jl_post_meta"><span
                                                                                class="jl_author_img_w"> <img
                                        ...
                                        <li class="menu-item menu-item-has-children"> <a href="shop.html">Shop<span
                                                    class="jl_menu_lb jl_lb_yellow">Now</span><span
                                                    class="border-menu"></span></a>
                                            <ul class="sub-menu">
                                        ...
                                        <div class="jellywp_about_us_widget_wrapper">
                                            ...
                                            <div class="social_icons_widget">
                                                <ul class="social-icons-list-widget icons_about_widget_display">
                                                    ...
                                                    <li><a href="#" class="tumblr" target="_blank"><i
                                                    ...
                                                    <li><a href="#" class="dropbox" target="_blank"><i
                                                                class="fa fa-dropbox"></i></a>
                                                    </li>
                                                    <li><a href="#" class="rss" target="_blank"><i
                                                                class="fa fa-rss"></i></a>
                                                    </li>
                                                    <li><a href="#" class="skype" target="_blank"><i
                                            ...
                                            <ul class="feature-post-list recent-post-widget">
                                                <li>
                                                    <a href="#"
                                                        ...
                                                        <img width="120" height="120"
                                                            src="assets/img/2019/03/daniel-korpai-1296140-unsplash-120x120.jpg"
                                                ...
                                                <li>
                                                    <a href="#"
                                                        ...
                                                        title="People are enjoy the job that they love">
                                                        <img width="120" height="120"
                                                            src="assets/img/2019/02/irina-iriser-654436-unsplash-120x120.jpg"
                                                            class="attachment-disto_small_feature size-disto_small_feature wp-post-image"
                                                            alt="" />
                                                        <div class="background_over_image"></div>
                                                    </a>
    ...
    <script src="assets/js/justified.js"></script>
