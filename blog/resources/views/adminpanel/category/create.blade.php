...
<div class="container-fluid mg-t-20">
    ...
    <div class="breadcrumb-header justify-content-between">
            ...
            <h4 class="content-title mb-1">კატეგორიის დამატება</h4>
                        ...
                        <div class="">
                            <div class="row mg-b-20">
                                <div class="parsley-input col-md-6" id="fnWrapper">
                                    <label>კატეგორიის სახელი: <span class="tx-danger">*</span></label>
                                    <input class="form-control" data-parsley-class-handler="#fnWrapper" name="name" required type="text">
                                </div>
                        </div>            
                        <div class="mg-t-30">
                            <button class="btn btn-main-primary pd-x-20" type="submit">დამატება</button>
                        </div>
                    </form>
                </div>
            </div>
